		...
		<TABLE BORDER=0  CELLSPACING=0 CELLPADDING=0>
			<TR><td colspan=2 align=center>
				...
				<Table cellspacing=0 cellpadding=6 border=0>
					<tr><td align=center><font face=arial size=5 color=#999933>Quality Supplies for Companion Animals</font><br>
			
<IMG SRC="IMAGES/sasha.jpg" border="0" width=138 height=177>&nbsp;<img src="images/workshopgp.jpg" border="0" width=169 height=160 >&nbsp;<img src="images/workshop.jpg" border="0" width=150 height=183><br>



<font face=arial size=4 color=#39638c><b>>> Shop here! 100% of our profits go to rabbit, rodent and ferret rescue! <br>
...
<!-- End PayPal Logo -->
<p>
<Font face="arial" size="5" color="#ffffff">All money donated goes directly to helping the animals in our shelter.  Can you help?</font><br>
</td></tr>	
...
<!--End Specials display-->
		...
		<a href="product.asp?Cat=7&Animal=3"><img  src="images/ferretxmas.jpg" width="306" height="206" vspace="5" hspace="5" alt="" border=0></a><br>
				<font size="4" face="verdana" color="red">
				<b> Help the animals AND spread some holiday cheer with our adorable cards!</b><br>
...
<table cellspacing=0 cellpadding=6 border=0>
			...
			<td align=center valign=top>
			<img src="images/newpics.jpg" width="148" height="432" border=0 vALIGN=TOP></td>	
...
countfile="\\premfs2\sites\premium6\blrrfh\database\count.txt"
...
call addcount("\\premfs2\sites\premium6\blrrfh\database\rabbit.txt")
Elseif address="www.rodenthouse.org" then
call addcount("\\premfs2\sites\premium6\blrrfh\database\rodent.txt")
Elseif address="www.ferrethouse.org" then
call addcount("\\premfs2\sites\premium6\blrrfh\database\ferret.txt")
elseif address="www.rabbitrodentferret.org" then
call addcount("\\premfs2\sites\premium6\blrrfh\database\rarofe.txt")
end if

-->
<Font face=arial color=#999933 size=3><b>Our hit counter will be back soon!  </b></font>
 <br>
