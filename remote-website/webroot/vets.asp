...
Select Case intAnimal
	Case 1:
	sql="Select * from Vet where WhichAn=1 order by City"

	Case 2:
	sql="Select * from Vet where WhichAn=2 order by City"

	Case 3:
	sql="Select * from Vet where WhichAn=3 order by City"

	Case 4:
	sql="Select * from Vet where WhichAn=4 order by City"
...
response.write "<b>"
	...
	response.write "</font></td><td><img src="""
