...
Select Case intAnimal
	...
	Case 1:
		strSQL = "SELECT ID, Name, Image, Width, Height, DescriptionLng, Variation1Des, Variation1Price, Catagory, Status, Rabbits, Variations FROM Products Where Catagory=" & intCat & "AND Rabbits=1 AND Status=1" &_
                         " Order by ID Desc"
		strSQLF = "Select Photo, Width, Height, FirstName, Caption, Rotation, Current From Rabbits Where Rotation=" & intCat & "AND Current=1"

	Case 2:
		strSQL = "SELECT ID, Name, Image, Width, Height, DescriptionLng, Variation1Des, Variation1Price, Catagory, Status, Rodents, Variations FROM Products Where Catagory=" & intCat & "AND Rodents=1 AND Status=1" &_
			" Order by ID Desc"
		strSQLF = "Select Photo, Width, Height, FirstName, Caption, Rotation, Current From Rodents Where Rotation=" & intCat & "AND Current=1"
		
	Case 3:
		strSQL = "SELECT ID, Name, Image, Width, Height, DescriptionLng, Variation1Des, Variation1Price, Catagory, Status, Ferrets, Variations FROM Products Where Catagory=" & intCat & "AND Ferrets=1 AND Status=1" &_
			" Order by ID Desc"
		strSQLF = "Select Photo, Width, Height, FirstName, Caption, Rotation, Current From Ferrets Where Rotation=" & intCat & "AND Current=1"
...
<table BORDER=0 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#FFFFFF" WIDTH=100% VALIGN=top>
	...
	<TR>
		...
		<TD COLSPAN="3" BGCOLOR="#FFCC66" HEIGHT="60" ALIGN=Center VALIGN=bottom><a name="topofpage"><IMG SRC="title.gif" WIDTH=530 HEIGHT=40 ALT="Best Little Rabbit, Rodent & Ferret House"></a></TD>
	</TR>

	<TR>
		<TD ROWSPAN=30 bgcolor="#FFCC66" WIDTH=5%><IMG SRC="spacer.gif" WIDTH=10 HEIGHT=1 alt=""></TD>
		<TD ALIGN=left VALIGN=top><IMG SRC="corner.gif" WIDTH="40" HEIGHT="40" ALT=""></TD>
...
<!--Display top links inside a nested table using include file-->
		...
		<TD ALIGN=center ROWSPAN=2 valign=top>
			...
			<TABLE  BGCOLOR="#FFCC66" WIDTH=100% CELLPADDING=0 CELLSPACING=0 BORDER=0>
				<TR>
				  <TD HEIGHT=10 BGCOLOR="#ffffff"><IMG SRC="spacer.gif" WIDTH=1 HEIGHT=10 ALT=""></td>
...
<!--End link display-->
		...
		<TD ALIGN =right VALIGN=top><IMG SRC="corner1.gif" WIDTH="40" HEIGHT="40" BORDER=0 ALT=""></TD>
...
<!--Display side links in nested table using include file-->
		...
		<TD ROWSPAN=6 VALIGN=top>
			...
			<TABLE CELLSPACING=0 CELLPADDING=0 BORDER=0 WIDTH=107>
				<TR>
				  <TD VALIGN=bottom><IMG SRC="head1.gif" WIDTH="10" HEIGHT="47" BORDER=0></TD>
				  <TD VALIGN=bottom><IMG SRC="head2.gif" WIDTH="87" HEIGHT="47" BORDER=0></TD>
				  <TD VALIGN=bottom ALIGN=right COLSPAN=2><IMG SRC="head3.gif" WIDTH="10" HEIGHT="47" BORDER=0></TD>
				</TR>
				<TR>
				  <TD>&nbsp;</TD>	
				  <TD><!--#include file="sidelink.asp"--></TD>
				  <TD BGCOLOR="#FFFFFF" WIDTH="5"><IMG SRC="spacer.gif" WIDTH=5 HEIGHT=1 ALT=""></TD>
				  <TD BGCOLOR="#FFCC66" WIDTH="5" ROWSPAN=2><IMG SRC="spacer.gif" WIDTH=5 HEIGHT=1 ALT=""></TD>
				</TR>
				<TR>
				  <TD COLSPAN=3 BGCOLOR="#FFFFFF" HEIGHT=10><IMG SRC="spacer.gif" WIDTH=1 HEIGHT=10 ALT=""><TD>
				</TR>
				<TR>
				  <TD COLSPAN=4 BGCOLOR="#FFCC66" HEIGHT=5><IMG SRC="spacer.gif" WIDTH=1 HIGHT=5></TD>
				</TR>
			</TABLE>
		</TD>
...
<!--End side link display-->		
		...
		<TD HEIGHT=40><IMG SRC="spacer.gif" HEIGHT=40 WIDTH=1></TD>

	</TR>

	<TR>
		<TD BGCOLOR="#FFCC66" HEIGHT="5" COLSPAN=2><IMG SRC="spacer.gif" WIDTH=1 HEIGHT=5 ALT=""></TD>
	</TR>
...
<!--Display Catagory Title images with variable title in center square-->
				...
				<TABLE WIDTH=239 BORDER=0 CELLSPACING=0 CELLPADDING=0>
					<tr>
					  <TD ROWSPAN=3><IMG SRC="logoa.gif" WIDTH=73 HEIGHT=110 ALT=""></TD>
		    			  <TD><IMG SRC="logob.gif" WIDTH=111 HEIGHT=37 ALT=""></TD>
		    			  <TD ROWSPAN=3><IMG SRC="logod.gif" WIDTH=55 HEIGHT=110 ALT=""></TD>
					</TR>
					<TR>
...
<!--Call functions to print selected Animal and Catagory in title image-->
					...
					<TR><TD><IMG SRC="logoc.gif" WIDTH=111 HEIGHT=33 ALT=""></TD></TR>
				</TABLE>
...
objConn.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.Mappath("\Data\rabbit.mdb") & ";"
...
If Not objRS.EOF THEN
	...
	Dim i
	Response.Write "<B><FONT FACE=""arial"" COLOR=#999933 SIZE=2>Page " & pg & " of " & objRS.PageCount & "<BR>"
...
<A HREF="cart.asp"><IMG SRC="check.gif" BORDER=0 WIDTH=45 HEIGHT=40></A></TD></TR></TABLE>
</TD></TR>


<TR><TD COLSPAN=2><HR NOSHADE WIDTH=40%></TD></TR>
...
If IsNull(strProduct) Then
	...
	Response.Write "<FORM METHOD=""post"" ACTION=""cart.asp"">"	
	Response.Write "<tr><TD align=right COLSPAN=2 VALIGN=bottom>" & "&#36; " & "<font color=#6699cc><b>" & strPrice & "</b></font><IMG SRC=""spacer.gif"" WIDTH=20>" 
...
VarEnc = Server.HTMLEncode(strProduct)
	...
	Response.Write "<tr><TD  COLSPAN=2 align=right valign=bottom><font face=""arial"">" & strProduct & "</font><img src=""spacer.gif"" width=20>" & "&#36;" & "<font color=#6699cc><b>" & strPrice & "</b></font><img src=""spacer.gif"" width=20>"
...
%>
	...
	<TR><TD COLSPAN=4><IMG SRC="spacer.gif" WIDTH=2 HEIGHT=10 ALT=""><HR NOSHADE SIZE=1 WIDTH=80%></TD></TR>
<%
...
<TR><TD COLSPAN=2 ALIGN=center>
    	...
    	<TABLE WIDTH="446" border=0 BGCOLOR="#BDD5EB" CELLPADDING=0 CELLSPACING=0>
		 ...
		 <tr>
		  <TD BGCOLOR="#474d64"><a name="featured"><IMG SRC="spacer.gif" WIDTH=1 HEIGHT=1 ALT=""></a></TD>
		  <TD BGCOLOR=#474D64><IMG SRC="spacer.gif" WIDTH=4 HEIGHT=1 ALT=""></TD>
		  <TD BGCOLOR=#474D6F><IMG SRC="spacer.gif" WIDTH=442 HEIGHT=1 ALT=""></TD>
		  <TD BGCOLOR=#474D6F><iMG SRC="spacer.gif" WIDTH=1 HEIGHT=1 ALT=""></TD>
		</TR>
		<TR>
		  <TD BGCOLOR="#474d64" WIDTH="1"><IMG SRC="spacer.gif" WIDTH=1 ALT=""></TD>
		  <TD BGCOLOR=#BDD5EB><IMG SRC="spacer.gif" WIDTH=4  ALT=""></TD>
		  <TD VALIGN="middle" ALIGN="center" WIDTH="442"><IMG VSPACE=10 HSPACE=10 ALIGN=right SRC="Features/<%=objRSF("Photo")%>" WIDTH=<%=objRSF("Width")%> HEIGHT=<%=objRSF("Height")%> ALT=<%=objRSF("FirstName")%>>
		    <P VALIGN="middle"><FONT COLOR=#000000 FACE="arial"><BR><H3><B><%=objRSF("Name")%></B></H3></P><P ALIGN=left VALIGN=middle><%=objRSF("Caption")%></FONT></TD>
		  <TD BGCOLOR=#474D64><IMG SRC="spacer.gif" WIDTH=1 ALT=""></td>
		</TR>
		<TR>
		  <TD COLSPAN=4 BGCOLOR=#474D64><IMG SRC="spacer.gif" HEIGHT=1></TD>
		<TR>		  
		...
		<TR>
		  <TD COLSPAN=4 ALIGN=center BGCOLOR=#FFF0C1><FONT FACE="arial" COLOR=#000000 ><B>Our featured companions already have happy homes, but many
			more are still looking.  Click <A HREF="http://www.houserabbit.org/AdoptedCurrent.asp">here</A> to visit adoptable rabbits, rodents and ferrets at BLRRFH.</B></FONT></TD>
		</TR>
	</TABLE>
...
<TR><TD COLSPAN=2><IMG SRC="spacer.gif" HEIGHT=20></TD></TR>

<%
'-------------------------------
'Close featured companion recordset object
'-------------------------------
...
Response.Write "<B><FONT FACE=""arial"" COLOR=#999933 SIZE=2>Page " & pg & " of " & objRS.PageCount & "</font><BR>"
		If objRs.PageCount>1 Then

		Response.Write "<b><FONT FACE=""arial"" COLOR=#4486c4 size=3>Go to page "
...
<td>
<a href="#topofpage"><img src="home.gif" width=45 height=40 border=0></a>

<a href="cart.asp"><img src="check.gif" border=0 width=45 height=40></a></td>
</tr>
</table>
</td>
