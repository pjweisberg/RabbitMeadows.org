...
<!--Begin main table-->
<!--Display title-->
<center><img src="images/title.gif" width="560" height="40" border=0 alt="Best Little Rabbit, Rodent and Ferret House"></center>
...
<!-- Specials display-->		
			  <TD VALIGN=TOP BGCOLOR="#ffffff"  rowspan=3>
					<TABLE  BGCOLOR="red"  HEIGHT=100% cellspacing=0 cellpadding=0 border=0  valign=top>
						<tr><td>				
...
<Tr bgcolor=#39638c><td bgcolor=#39638c ALIGN=CENTER>
<font color="#ffcc66" SIZE=5><b>FINALLY in PAPERBACK!<hr></font>
<font color=#ffffff SIZE=4><b> Rabbit Health <br>in the 21st Century </FONT><FONT COLOR=#FFFFFF size=2><BR>
						 What Every Bunny's Parent Needs to Know.<br><a href="product.asp?Cat=8&Animal=1">
						<img src="images\health101s.jpg" width=79 height=104 border=0></a><br> * New drug section with most up-to-date perspective!<hr width=25%>
							                                                                                                  * Expanded <i>Herbal Treatments</i> section!</b></font>
						</td></tr></table></center>
						</td></tr>
...
<!--End Specials display-->
			  <tr>
<TD valign="top">
<Table cellpadding=5 border=0 cellspacing=2 bgcolor="red" valign="top"><tr>
...
<a href="/RabbitMeadowsSanctuary.htm"><img  align="right" src="images/rabbitsanctuarysmall.jpg" width="229" height="327" vspace="5" hspace="5" alt="" border=0></a><br>
			<font face="arial" size="3"> Rabbit Meadows Sanctuary is working with Woodland Park Zoo in Seattle to relocate the hundreds of abandoned and suffering domestic rabbits on the grounds of the zoo.   The zoo has long been a dumping ground for rabbits who are no longer wanted. As they breed and their numbers multiply, hundreds of domestic rabbits are left in a situation where they have to fend for themselves.  Ill equipped to do this, they suffer all manner of painful deaths from disease, predators and cars.  We will be trapping and relocating ALL of these rabbits to the Rabbit Meadows Sanctuary (pictured) where they will be safe and happy, as they all  deserve to be. <br><br>
