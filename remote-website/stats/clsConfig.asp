	...
	Public Sub GenerateSettings(intSetting)
		...
		Case 3 ' MAINTENANCE
			...
			With Response
				...
				.Write("Definitions allow Site Statistics to detect ")
				...
				Else
					.Write("<tr><td style=""width:300px;""><p><small>File upload has been disabled because Site Statistics is configured to use ")
					.Write("MS Access with the default database location and file name. This is a security risk. This can fixed by following ")
					.Write("these <a href=""http://www.metasun.com/support/metatraffic/secure_db.asp"">instructions</a>.</td></tr>")
				End If
				.Write("</table></td></tr>")
		...
		Case 4 ' ACTIONS
			...
			Case "UPDATE", "ADD NEW"
				...
				If strAction = "ADD NEW" Then 
					If strActionCode = "" Then
						strError = "<p class=error>Code cannot be blank.</p>"
					ElseIf strActionName = "" Then
						strError = "<p class=error>Name cannot be blank.</p>"
					ElseIf CInt(CheckCode(strActionCode)) = 0 Then
						strError = "<p class=error>Code can only contain " &_
							"letters, numbers, hyphen (-) and underscore (_). Spaces are not permitted.</p>"
						strActionCode = ""
					Else
						...
						If Not rsCheck.Eof Then
							strError = "<p class=error>Code already exists.</p>"
						End If
						rsCheck.Close : Set rsCheck = Nothing
					End If					
				End If
			...
			Case "EDIT"
				...
				With Response
					.Write("<form method=post>")
					.Write("<tr><td><strong>Code:</strong> </td>")
					.Write("<td>")
					.Write("<input type=text size=12 maxlength=12 name=code value=""" & strActionCode & """" & strReadonly & ">")
					.Write("</td></tr>")
					.Write("<tr><td><strong>Name:</strong> </td>")
					.Write("<td>")
					.Write("<input type=text size=30 maxlength=255 name=name value=""" & strActionName & """>")
					.Write("</td></tr>")
					.Write("<tr><td><strong>Display in Reports?</strong> </td>")
					.Write("<td>")
					.Write("<input type=checkbox name=Display value=1 " & SetInputState(blnDisplay, True, " checked") & " class=checkbox>")
					.Write("</td></tr>")
					.Write("<input type=hidden name=action value=""" & strAction & """>")
					.Write("<tr><td colspan=2 align=center><input type=image name=action src=""images/" & Replace(strAction, " ", "_") & "_btn.gif""></td></tr>")
					.Write("</form>")
			...
			Case "VIEW"
				...
				With Response
					If rsQuery.Recordcount > 0 Then
						.Write("<tr><th>Name</th><th>Code</th><th>Display</th><th>Action</th></tr>")
						Do While Not rsQuery.Eof
							...
							.Write("<tr class=" & strClass & ">")
							.Write("<td>" & rsQuery(1) & "</td>")
							.Write("<td>" & rsQuery(0) & "</td>")
							.Write("<td align=center>" & DisplayAdmin(rsQuery(2)) & "</td>")
							.Write("<td><input type=image src=""images/edit_btn.gif"" onclick=""document.location='?s=4&m=EDIT&code=" & rsQuery(0) & "'""></td>")
							.Write("</tr>")
							rsQuery.Movenext
						Loop
					Else
						.Write("<tr><td colspan=3>There are no actions configured.</td></tr>")
					End If
					
					rsQuery.Close : Set rsQuery = Nothing
					
					.Write("<tr><td colspan=4 align=center>")
					.Write("<input type=image src=""images/add_new_btn.gif"" value=""ADD NEW"" onclick=""document.location='?s=4&m=EDIT&id=0'"">")
					.Write("</td></tr>")
				End With
		...
		Case 5 ' CAMPAIGNS
			...
			Case "EDIT"
				...
				With Response
					...
					.Write("<tr><td><strong>Code:</strong> </td>")
					.Write("<td>")
					.Write("<input type=text size=12 maxlength=12 name=code value=""" & strCampaignCode & """" & strReadonly & ">")
					.Write("</td></tr>")
					.Write("<tr><td><strong>Name:</strong> </td>")
					.Write("<td>")
					.Write("<input type=text size=30 maxlength=255 name=name value=""" & strCampaignName & """>")
					.Write("</td></tr>")
					.Write("<input type=hidden name=action value=""" & strAction & """>")
					.Write("<tr><td colspan=2 align=center><input type=image name=action src=""images/" & Replace(strAction, " ", "_") & "_btn.gif""></td></tr>")
					.Write("</form>")
			...
			Case "VIEW"
				...
				With Response
					If rsQuery.Recordcount > 0 Then
						.Write("<tr><th>Name</th><th>Code</th><th>Action</th></tr>")
						Do While Not rsQuery.Eof
							...
							.Write("<td>" & rsQuery(1) & "</td>")
							.Write("<td>" & rsQuery(0) & "</td>")
							.Write("<td><input type=image src=""images/edit_btn.gif"" onclick=""document.location='?s=5&m=EDIT&code=" & rsQuery(0) & "'"">&nbsp;")
							.Write("<input type=image src=""images/delete_btn.gif"" onclick=""document.location='?s=5&m=DELETE&code=" & rsQuery(0) & "'""></td>")
							.Write("</tr>")
							rsQuery.Movenext
						Loop
					Else
						.Write("<tr><td colspan=3>There are no campaigns configured.</td></tr>")
					End If
					
					rsQuery.Close : Set rsQuery = Nothing
					
					.Write("<tr><td colspan=4 align=center>")
					.Write("<input type=image src=""images/add_new_btn.gif"" value=""ADD NEW"" onclick=""document.location='?s=5&m=EDIT&id=0'"">")
					.Write("</td></tr>")
				End With
