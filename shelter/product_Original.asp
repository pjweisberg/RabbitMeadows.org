...
<%
'dim strConnect
'strConnect="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\sites\Single16\hrabbit\database\hrs.mdb"
...
<input type="image" src="images/check.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
...
' no variations
	...
	Response.Write "<tr><TD align=right COLSPAN=2 VALIGN=top>" & "&#36; " & "<font color=#6699cc><b>" & strPrice & "</b></font>" 
	%>
<input type="hidden" name="cmd" value="_cart">
<input type="hidden" name="business" value="Sandi@RabbitRodentFerret.org">
<input type="hidden" name="item_name" value="<%=objRS("Name")%>">
<input type="hidden" name="item_number" value="<%=objRS("ID")%>">
<input type="hidden" name="amount" value="<%=formatnumber(strPrice)%>">
<input type="hidden" name="return" value="http://www.rabbitrodentferret.org/thankyou.asp">
...
'split variations and price into an array	
...
Response.Write arrProduct(strElement) & "&#160;" & "&#160;" & "&#36; <font color=#6699cc><b>"  & arrPrice(strElement) & "</b></font>"

%>
<input type="hidden" name="cmd" value="_cart">
<input type="hidden" name="business" value="Sandi@RabbitRodentFerret.org">
<input type="hidden" name="item_name" value="<%=NameEnc %>, <%=VarEnc%>">
<input type="hidden" name="item_number" value="<%=objRS("ID")%>">
<input type="hidden" name="amount" value="<%=arrPrice(strElement)%>">
<input type="hidden" name="return" value="http://www.rabbitrodentferret.org/thankyou.asp">
<input type="hidden" name="currency_code" value="USD">
<input type="hidden" name="lc" value="US">
<input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
