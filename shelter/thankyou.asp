...
<!--Inner table-->
	...
	<TD BGCOLOR="#FFFFFF" COLSPAN=2 ALIGN=center valign=top>
		...
		<IMG SRC="images\thanks.gif" WIDTH=240 HEIGHT=185>
		</TD></TR>
		<TR><TD ALIGN=LEFT VALIGN=TOP>
		<FONT FACE=ARIAL SIZE=5 COLOR=#39638C>
		The Best Little Rabbit, Rodent and Ferret House thanks you for your purchase.  
		The proceeds will go to support our shelter efforts.	
		
		<P>
		If you provided an e-mail address you will be sent a notice when your order is shipped. <BR>
		</FONT></P>
		</TD></TR>
