...
<TITLE> Rabbit Meadows Sanctuary </TITLE>
...
<TABLE cellpadding="0" border="0" cellspacing="0" bgcolor="#FFFFFF" width="887">
	<tr>
		<td valign="bottom" align="left" colspan="2"><img src="sanctuary_header.jpg" width="887" height="159" border="0" >
		</td>
	</tr>

	<tr>
		<td valign=top bgcolor="#5a755c">
			<table class="green" width="214">
				
				
				<tr>
				
					<td class="question" valign="top" align=center>
					<B>What is life like at the sanctuary?</B>
					</td>
				</tr>
					
				<tr>
					<td class="answer"><img src="love.jpg" width="83" height="85" align="right" vspace="5">
					Rabbits at the sanctuary are able to live naturally in family groups. They do not have to dodge cars, or run from coyotes, or dodge hawks and owls. <p>They are well fed and happy and have a much longer average life than they did on their own outside of the sanctuary. 
					</td>
				</tr>
				<tr>
				
					<td class="question" valign="top" align=center>
					<B>What is a feral rabbit?</B>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="question" valign="top" align=center>
					<B>What if a rabbit gets sick?</B>
					</td>
				</tr>
					
				<tr>
					<td class="answer"><img src="handfeed.jpg" width="115" height="143" align="left">
					When any of the feral rabbits need to be picked up and checked for a medical problem, you can see how this can be easily accomplished. Since the feral rabbits will take food (especially fruit) directly from attendants'  hands, they can just be "snatched" up and examined or monitored for a day or two to determine if vet care is needed. <p>The liver coccidia that many of them came with has been totally eliminated.
					</td>
				</tr>
				...
				<tr>
					...
					<td class="question" valign="top" align=center>
					<B>What do the rabbits eat?</B>
					</td>
				</tr>
					
				<tr>
					<td class="answer"><img src="apple1.jpg" width="137" height="91" align="right">
					These rabbits are cautiously sharing an apple. Just like kids, fruit is much tastier than veggies. They often enjoy watermelon, strawberries, apples, bananas, pears, mangos, etc.<p>In addition, we feed these rabbits ten bales of alfalfa each week and several cases of veggies each day. Our rabbits use lots of bales of straw to keep warm.
					</td>
				</tr>
		...
		<td valign="top">
			<table class="white">
				...
				<tr>
					...
					<p align=center><font face="arial" size="4"><B>OUR ADOPTION CENTER IS COMING!</B></font><p align=left><img src="onebunny.jpg" align="right" hspace="5" width="109" height="160"><font face="arial" size="3">   <p>Many of you
					have followed our search for a place that would allow us to care for the sanctuary rabbits and have our 					shelter bunnies and adoption center in the same location.  Rabbit Meadows, our beautiful 4 1/2 acres 7 miles east of Redmond, was perfect except that the zoning laws would not allow the shelter (too much traffic).  Then, in the
					midst of our frustrating search, King County changed the zoning and now we can have it all!<p>It's going to be a lot of effort, but our plan is to create an adoption center at Rabbit Meadows, complete with a veterinary clinic, an education room, and many other things.  It is all very exciting!<p><img src="mainrescue.jpg" align="left" width="146" height="216" hspace="5">


	 If you would like to contribute to this effort and to our continuing rescue work, please send a donation today!<img src="salad2.jpg" width="218" height=""105" align="right" hspace="5">
	 <p align=center>
	 <!-- Begin PayPal Logo -->
...
Running the sanctuary takes a considerable amount of time, effort and money.  Although the rabbits live in a natural way, they must still be fed and have their medical needs taken care of.  However, we believe that all rabbits, regardless of temperament or affinity for humans, deserve to live out their lives <B>free from fear, pain, hunger and emotional or physical suffering.</B>  At Rabbit Meadows Sanctuary, they are doing exactly that.
<p align=left>
