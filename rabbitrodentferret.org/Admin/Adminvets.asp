...
case "New"
	Call DisplayRecord(0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,"Adding")
case "Edit"
	sql="Select * from vet Where Id=" & request("Index")
	set rsJokes=Conn.execute(sql)
	Call DisplayRecord(request("Index"),rsJokes("Name"),rsJokes("Rabbits"),rsJokes("Rodents"),rsJokes("Ferrets"),rsJokes("Guineas"),rsJokes("HeaderLocation"),rsJokes("Location"),rsJokes("Address"),rsJokes("City"),rsJokes("Zip"),rsJokes("Phone"),rsJokes("Phone2"),rsJokes("Fax"),rsJokes("email"),rsJokes("hours"),rsJokes("photo"),rsJokes("comments"),"Updating")
case "Delete"
	sql="Select * from vet Where Id=" & request("Index")
	set rsJokes=Conn.execute(sql)
	Call DisplayRecord(request("Index"),rsJokes("Name"),rsJokes("Rabbits"),rsJokes("Rodents"),rsJokes("Ferrets"),rsJokes("Guineas"),rsJokes("HeaderLocation"),rsJokes("Location"),rsJokes("Address"),rsJokes("City"),rsJokes("Zip"),rsJokes("Phone"),rsJokes("Phone2"),rsJokes("Fax"),rsJokes("email"),rsJokes("hours"),rsJokes("photo"),rsJokes("comments"),"Deleting")
case "Submit New"
	...
	sql="INSERT INTO vet ([id],[Name],[Rabbits],[Rodents],[Ferrets],[Guineas],[HeaderLocation],[Location],[Address],[City],[zip],[phone],[phone2],[fax],[email],[hours],[photo],[comments]) VALUES("
	sql=sql & iMax & ","
	sql=sql & "'" & replace(request("Name"),"'","''") & "',"
	sql=sql & nulltozero(request("Rabbits")) & ","
	sql=sql & nulltozero(request("Rodents")) & ","
	sql=sql & nulltozero(request("Ferrets")) & ","
	sql=sql & nulltozero(request("Guineas")) & ","
...
case "Submit Changes"
	...
	sql=sql & "[Rabbits]=" & nulltozero(request("Rabbits")) & ","
	sql=sql & "[Rodents]=" & nulltozero(request("Rodents")) & ","
	sql=sql & "[Ferrets]=" & nulltozero(request("Ferrets")) & ","
	sql=sql & "[Guineas]=" & nulltozero(request("Guineas")) & ","
	...
	sql=sql & "[photo]='" & replace(request("photo"),"'","''") & "',"
...
' Display a record
'--------------------------------------------------------------------
Sub DisplayRecord(iIndex,sName,sRabbits,sRodents,sFerrets,sGuineas,sHeaderLocation, sLocation,sAddress,sCity,sZip,sPhone,sPhone2,sFax,semail,shours,sPhoto,sComments,sMode)
%>
	...
	<tr>
		<th align="right">Treats who?</th>
		<td><input type="checkbox" name="Rabbits" value="1" <%=checkornot(sRabbits)%>> Rabbits
		    <input type="checkbox" name="Rodents" value="1" <%=checkornot(sRodents)%>> Rodents
			<input type="checkbox" name="Ferrets" value="1" <%=checkornot(sFerrets)%>> Ferrets
			<input type="checkbox" name="Guineas" value="1" <%=checkornot(sGuineas)%>> Guinea Pigs</td>
    </tr>
	<tr>
	...
	<tr>
		<th align="right" valign="top">Photo file name</th>
		<td><input name="Photo" type="text" size="30" value="<%=sPhoto%>"></td>
	</tr>
	<tr>
