...
<head>
<title>HouseRabbit.org - Ferrets</title>
<meta NAME="Keywords"
...
<!--webbot bot="Include" endspan i-checksum="14527" -->
    ...
    <td><b><font face="comic sans ms, arial" color="#400040" size="5">Ferret
    Rescue</font></b>
...
'--------------------------------------------------------------------
sql="Select * from AdoptFerrets where archive=false order by Name, Adopted DESC"
